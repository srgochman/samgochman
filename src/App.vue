...
export default {
  ...
  mounted() {
    ...
    this.nameTL = gsap.timeline({
      scrollTrigger: {
        ...
        // scrub: true,
        markers: true,
        onEnter: this.collapseName,
        // toggleActions: "play none reverse none"
        onEnterBack: this.expandName
      }
    });
    // nameTL.to(".fade", {
    //   opacity: 0,
  ...
  methods: {
    ...
    collapseName() {
      // this.nameTL.to(".fade-out", { opacity: 0, x: -40, duration: 0.3 });
    ...
    expandName() {
      ...
      // this.nameTL.to(".fade-out", { opacity: 1, x: 0, duration: 0.3 });
    }
  }
};
</script>
